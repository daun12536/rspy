...
local unreliable = Instance.new("UnreliableRemoteEvent",Storage)
...
local originalEvent2 = unreliable.FireServer
...
local newFireServer2 = newcclosure(function(...)
    return newindex("FireServer",originalEvent2,...)
end)
...
local function disablehooks()
    if synv3 then
        ...
        unhook(Instance.new("UnreliableRemoteEvent").FireServer, originalEvent2)
        ...
        hookfunction(Instance.new("UnreliableRemoteEvent").FireServer, originalEvent2)
...
function toggleSpy()
    if not toggle then
        ...
        if synv3 then
            ...
            originalEvent2 = hook(Instance.new("UnreliableRemoteEvent").FireServer, clonefunction(newFireServer2))
            ...
            originalEvent2 = hookfunction(Instance.new("UnreliableRemoteEvent").FireServer, clonefunction(newFireServer2))
